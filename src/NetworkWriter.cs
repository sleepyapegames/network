...
namespace Ape.Netcode
{
    public class NetworkWriter
    {
        ...
        public NetworkWriter() : this(true, InitialSize) { }

        public NetworkWriter(bool autoResize) : this(autoResize, InitialSize) { }

        public NetworkWriter(bool autoResize, int initialSize)
        {
        ...
        public static NetworkWriter FromBytes(byte[] bytes, bool copy)
        {
            if (copy)
            {
                var netDataWriter = new NetworkWriter(true, bytes.Length);
                netDataWriter.Put(bytes);
                return netDataWriter;
            }
            return new NetworkWriter(true, 0) { _data = bytes, _position = bytes.Length };
        }
        ...
        public static NetworkWriter FromBytes(byte[] bytes, int offset, int length)
        {
            var netDataWriter = new NetworkWriter(true, bytes.Length);
        ...
        public static NetworkWriter FromString(string value)
        {
            var netDataWriter = new NetworkWriter();
        ...
        public void Put(float value)
        {
            ...
            NetworkBitConverter.GetBytes(_data, _position, value);
            _position += 4;
        }
        ...
        public void PutSBytesWithLength(sbyte[] data, int offset, int length)
        {
            ...
            NetworkBitConverter.GetBytes(_data, _position, length);
        ...
        public void PutSBytesWithLength(sbyte[] data)
        {
            ...
            NetworkBitConverter.GetBytes(_data, _position, data.Length);
